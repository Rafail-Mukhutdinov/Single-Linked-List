...
public:
	...
	[[nodiscard]] ConstIterator cbefore_begin() const noexcept {
		ConstIterator cbefore_begin(const_cast<Node*>(&head_));
	...
	[[nodiscard]] ConstIterator before_begin() const noexcept {
		ConstIterator before_begin(&head_);
		return before_begin;
	}
	...
	void PopFront() noexcept {
		...
		head_.next_node = prev_node->next_node;
		--size_;
		delete prev_node;
	}
	...
	Iterator EraseAfter(ConstIterator pos) noexcept {
		...
		Node* post_node = next_node->next_node;
